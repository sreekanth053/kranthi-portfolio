    ...
    <div className="home-container">
      <div className="home-content">
        <div className="align-left">
          ...
          <p className="kkk2">
            Building bridges between frontend and backend, transforming ideas
            into responsive reality.
          </p>
          <div className="social-icons">
            <a
              href="https://www.linkedin.com/in/kranthi-kumar-81453113a/"
              target="_blank"
            ...
            <a
              href="https://github.com/klmamatha"
              target="_blank"
              rel="noopener noreferrer"
              className="social-icons1"
            >
          ...
          <button
            ...
            onClick={() =>
              window.open(
                process.env.PUBLIC_URL + "/kranthi resume.pdf",
                "_blank"
              )
            }
          >
